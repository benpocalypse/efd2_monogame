                        ...
                        case MT_ENTRANCE:
                            {
                                IComponent[] componentCollection = new IComponent[]
                                    ...
                                    new Drawable(entrance) { ZOrder = DisplayLayer.Foreground },
                                    new Collidable()
                                    };
                        ...
                        case MT_EXIT:
                            {
                                ...
                                {
                                    new Positionable() { CurrentPosition = new Vector2((MAP_X_OFFSET*8) + (i*8), (MAP_Y_OFFSET * 8) + (j * 8)), ZOrder = (float)DisplayLayer.Foreground },
                                    new Drawable(exit) { ZOrder = DisplayLayer.Foreground },
                                    ev,
                                    new Collidable()
                                };
                        ...
                        case MT_FLOOR:
                            {
                                ...
                                new Drawable(floorAnim) { ZOrder = DisplayLayer.Background }
                                };
