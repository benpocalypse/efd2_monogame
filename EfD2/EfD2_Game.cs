...
namespace EfD2
{
    public class EfD2_Game : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            sword.AddComponent(new Positionable { RelativePosition = new Vector2(8, 8), PositionMode = PositionModeEnum.Relative, RelativeReference = playerEntity, ZOrder = DisplayLayer.Floating });
